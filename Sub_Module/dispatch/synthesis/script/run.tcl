...
analyze -format sverilog ../../../../rtl/dispatch.sv
elaborate dispatch
link
current_design
...
get_ports *clk*
read_sdc -echo ../script/dispatch.sdc
...
write_icc2_files -output ../output/dispatch_allfiles.v
write_file -format verilog -hierarchy -output ../output/dispatch_Netlist.v

write -hierarchy -format ddc -output ../output/dispatch_hierarchy.ddc
write -hierarchy -format verilog -output ../output/dispatch_hierarchy.v

write_sdc ../output/dispatch.sdc
write_parasitics -output ../output/dispatch_parasitics
write_sdf ../output/dispatch.sdf