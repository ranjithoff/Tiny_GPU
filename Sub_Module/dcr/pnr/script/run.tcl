...
read_verilog ../../synthesis/output/dcr_Netlist.v
current_design
...
report_lib -parasitic_tech dcr.dlib
...
##load_upf ../../synthesis/output/dcr_allfiles.v/dcr.upf
commit_upf
...
get_ports *clk*
source -echo ../../synthesis/output/dcr.sdc
...
save_block -as dcr/1_initial_design_done
...
initialize_floorplan -core_utilization 0.6 -side_ratio {2 2} -core_offset {2}
...
source ../script/dcr_pns.tcl

check_pg_connectivity
check_pg_drc
check_pg_missing_vias

save_block -as dcr/2_power_network_synthesis_done
...
save_block -as dcr/3_Boundary_cells_insertion_done
...
save_block -as dcr/4_placement_done
...
save_block -as dcr/6_routing_done
...
save_block -as dcr/7_report_generation_done
...
write_gds ../output/dcr.gds

save_block -as dcr/9_file_generator_done
